...
export const action = async ({ request }) => {
  ...
  const data = {
    ...
    textColor: formData.get("textColor")?.toString() || "#0f172a",
...
export default function WidgetSettings() {
  ...
  const [formState, setFormState] = useState({
    heading: settings.heading && settings.heading !== "Find Your Part" ? settings.heading : "FIND YOUR PART",
    subheading: settings.subheading && settings.subheading !== "Search by Application" ? settings.subheading : "SEARCH BY APPLICATION",
    yearLabel: settings.yearLabel && settings.yearLabel !== "Year" ? settings.yearLabel : "YEAR",
    makeLabel: settings.makeLabel && settings.makeLabel !== "Make" ? settings.makeLabel : "MAKE",
    modelLabel: settings.modelLabel && settings.modelLabel !== "Model" ? settings.modelLabel : "MODEL",
    searchButtonText: settings.searchButtonText && settings.searchButtonText !== "Search" ? settings.searchButtonText : "SEARCH",
    clearButtonText: settings.clearButtonText && settings.clearButtonText !== "Clear" ? settings.clearButtonText : "CLEAR",
    primaryColor: (settings.primaryColor && settings.primaryColor !== "#008060" && settings.primaryColor !== "#934b17") ? settings.primaryColor : "#0f172a",
    textColor: (settings.textColor && settings.textColor !== "#ffffff") ? settings.textColor : "#0f172a",
    backgroundColor: (settings.backgroundColor && settings.backgroundColor !== "#f4f6f8" && settings.backgroundColor !== "#1a1a1a") ? settings.backgroundColor : "#ffffff",
